...
const platformRoot = resolve(repositoryRoot, "owen-mdbox", "mac-arm")
...
console.log(`Pinned owen-mdbox/mac-arm/${options.version} to ${options.revision}; removed previous builds.`)
